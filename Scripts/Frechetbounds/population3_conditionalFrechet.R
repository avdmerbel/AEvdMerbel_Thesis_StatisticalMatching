# In this script the conditional frechet bounds are calculated for population 3
...
agg = 
  lapply(pop3$AggregatedDistribution, xtabs, formula = proportion ~.)
...
results[results$method == "IVA" & results$population == 3 & results$situation == "Instrumental", "conditional_lower"] = lower_ins
results[results$method == "IVA" & results$population == 3 & results$situation == "Instrumental", "conditional_upper"] = upper_ins

results[results$method == "CIA" & results$population == 3 & results$situation == "Instrumental", "conditional_lower"] = lower_ins
results[results$method == "CIA" & results$population == 3 & results$situation == "Instrumental", "conditional_upper"] = upper_ins
...
results[results$method == "IVA" & results$population == 3 & results$situation == "Mediator", "conditional_lower"] = lower_med
results[results$method == "IVA" & results$population == 3 & results$situation == "Mediator", "conditional_upper"] = upper_med

results[results$method == "CIA" & results$population == 3 & results$situation == "Mediator", "conditional_lower"] = lower_med
results[results$method == "CIA" & results$population == 3 & results$situation == "Mediator", "conditional_upper"] = upper_med
...
results[results$method == "IVA" & results$population == 3 & results$situation == "Outcome", "conditional_lower"] = lower_out
results[results$method == "IVA" & results$population == 3 & results$situation == "Outcome", "conditional_upper"] = upper_out

results[results$method == "CIA" & results$population == 3 & results$situation == "Outcome", "conditional_lower"] = lower_out
results[results$method == "CIA" & results$population == 3 & results$situation == "Outcome", "conditional_upper"] = upper_out
