setwd("F:/Documents/Thesis_StatisticalMatching/R/Simulations/CIA_unrestricted")

pop1 = 
  readRDS("simulate_population1_CIA.RData")
...
pop2 = 
  readRDS("simulate_population2_CIA.RData")
...
pop3 = 
  readRDS("simulate_population3_CIA.RData")
...
pop4 = 
  readRDS("simulate_population4_CIA.RData")
...
pop5 = 
  readRDS("simulate_population5_CIA.RData")
