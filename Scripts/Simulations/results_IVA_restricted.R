setwd("F:/Documents/Thesis_StatisticalMatching/R/Simulations/IVA_restricted")

pop1 = 
readRDS("simulate_population1_IVA_res.RData")
...
pop2 = 
  readRDS("simulate_population2_IVA_res.RData")
...
pop3 = 
  readRDS("simulate_population3_IVA_res.RData")
...
pop4 = 
  readRDS("simulate_population4_IVA_res.RData")
...
pop5 = 
  readRDS("simulate_population5_IVA_res.RData")
...
# rel = 
#   results[results$combination == "M2I1" | results$combination == "M1I2",][,c(8:11)]
# 
# rel = 
#   rel[seq_len(nrow(rel)) + c(1,-1),]
# 
# results[results$combination == "M2I1" | results$combination == "M1I2",][,c(8:11)] = rel
# 
# results$method = "IVA"
# results$restriction = "YES"
# 
# saveRDS(results, "F:/Documents/Thesis_StatisticalMatching/Tables_Thesis/PlotData_Estimates.RData")
